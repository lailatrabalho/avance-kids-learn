        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-lg card-hover">
            <div className="gradient-card-1 p-6 text-white">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <div className="inline-block bg-white/20 px-3 py-1 rounded-full text-xs mb-2 fredoka">3-4 ANOS</div>
                  <div className="inline-block bg-white/20 px-3 py-1 rounded-full text-xs fredoka">8 ATIVIDADES</div>
                </div>
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-lg card-hover">
            <div className="gradient-card-2 p-6 text-white">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <div className="inline-block bg-white/20 px-3 py-1 rounded-full text-xs mb-2 fredoka">4-5 ANOS</div>
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-lg card-hover">
            <div className="gradient-card-3 p-6 text-white">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <div className="inline-block bg-white/20 px-3 py-1 rounded-full text-xs mb-2 fredoka">5-6 ANOS</div>
                  <div className="inline-block bg-white/20 px-3 py-1 rounded-full text-xs fredoka">16 ATIVIDADES</div>
                </div>
                <div className="w-16 h-16 bg-white rounded-full overflow-hidden">
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-2xl card-hover border-4 border-gold relative" style={{ boxShadow: '0 0 30px rgba(255, 193, 7, 0.4)' }}>
            <div className="gradient-card-4 p-6 text-white">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <div className="inline-block bg-white/20 px-3 py-1 rounded-full text-xs mb-2 fredoka">3-6 ANOS</div>
              ...
              <p className="poppins text-sm leading-relaxed text-white/90">Todos os pacotes reunidos! Kit completo com progressão total do desenvolvimento infantil de 3 a 6 anos.</p>
              <div className="mt-4 flex items-center">
