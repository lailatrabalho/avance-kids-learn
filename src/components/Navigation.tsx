    ...
    <nav className="bg-white/95 backdrop-blur-sm shadow-lg py-3 sm:py-4 px-4 sm:px-6 border-b-2 border-gold/30 sticky top-0 z-50 transition-all duration-300">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <Button 
          ...
          className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white poppins font-bold text-xs sm:text-sm px-2 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-full shadow-lg hover:shadow-xl hover-scale border-2 border-green-400/20 relative overflow-hidden group transition-all duration-300 min-h-[40px] sm:min-h-[44px]"
          translate="no"
        >
          ...
          <span className="text-sm sm:text-base md:text-lg mr-1 sm:mr-2 relative z-10 group-hover:scale-110 transition-transform duration-300">💬</span>
          <span className="hidden sm:inline relative z-10 text-xs sm:text-sm">WhatsApp</span>
          <span className="sm:hidden relative z-10 text-xs">Chat</span>
        </Button>
      </div>
    </nav>
  );
